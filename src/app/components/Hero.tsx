        ...
        <div className='w-full h-screen'>
            ...
            <div className='absolute top-0 w-full h-full flex flex-col justify-center text-white'>
                <div className='md:left-[10%] max-w-[1100px m-auto absolute] px-4'>
                    ...
                    <p className='max-w-[600px] drop-shadow-2xl py-2 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui aspernatur dolorum ex perspiciatis ut et odit pariatur illo accusantium assumenda.</p>
                    <button className='bg-white text-black hover:shadow-2xl'>Reserve Now!</button>
                </div>
            </div>
        </div>
    )
